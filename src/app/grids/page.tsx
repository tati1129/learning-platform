...
export default function Grids() {
  return (
    <div>
        ...
        <div className="bg-blue-200 col-span-5 min-h-10">3</div>
        <div className="bg-blue-200 col-span-1 min-h-10">4</div>
        <div className="bg-yellow-50 col-span-4 col-start-2 min-h-10">5</div>
        </div>

        <h2>Breakpoint</h2>
        <div className="w-32 sm:w-74 md:w-100 bg-amber-100">A</div>

        <h2>Flexible design with grid</h2>
